...
local venyx = library.new("Fly GUI by DogeX", 5013109572)
...
function UGHHHHHH(title,text,time)
...
local page = venyx:addPage("Sec", 5012544693)
local section1 = page:addSection("Fly")
 FLYMODE = 'Default'
    FLYSPEED = 20
...
section1:addButton("+ Fly speed",function()
        FLYSPEED = FLYSPEED + 3
        UGHHHHHH('FlySpeed changed', tostring(FLYSPEED), 3)
    end)
   section1:addButton("- Fly speed",function()
        FLYSPEED = FLYSPEED - 3
        UGHHHHHH('Speed changed', tostring(FLYSPEED), 3)
    end)


section2:addKeybind("Change Key Toggle ui", Enum.KeyCode.One, function()
venyx:toggle()
end, function()
end)
